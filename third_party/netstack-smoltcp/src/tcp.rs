...
// was insufficient in optimized same-host validation; 128 KiB preserves the
// ordinary EasyTier socket window while removing most idle reservation.
const SMOLTCP_TCP_SEND_BUFFER_SIZE: usize = 128 * 1024;
const SMOLTCP_TCP_RECV_BUFFER_SIZE: usize = 128 * 1024;
