...
## 2026-07-18 progress-safe adaptive Stream 256 KiB-window candidate

- Parent snapshot: `6c377afe`; build affecting; not dispatched. Locked smoltcp is `0a926767a68bc88d5512afefa7529c5ecdade4ea`, inspected at `/tmp/netstack-smoltcp-0a926767`. Locked Leaf remains `4af133266367bc6ef1d369b4b519a0a56da48760`, inspected at `/private/tmp/leaf-audit-4af133266-v2`.
...
- The implementation and tests are otherwise identical to the liveness-proven `5e6d455b` structure. Frozen build-affecting diff SHA-256: `cfc42f65478c15d1cc1fa4d8946dc9eeea4e85b4a7322bfbdba020ac67aba102`. Fresh `.160` locked no-run and all focused exact-binary tests passed after the 256 KiB constant change; `Cargo.lock`, platform `cfg`, generated files and workflow pins remain unchanged. No evidence from the rejected 128 KiB artifact is reused as throughput proof.
